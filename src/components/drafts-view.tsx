...
export default function DraftsView(
  { drafts, onDelete, onAddDraft, onEditDraft, onSendDraft }: DraftsViewProps) {
  ...
  const handleSendClick = (draft: Draft) => {
    onSendDraft?.(draft)
    onDelete(draft.id)
  }
          ...
          <div className="divide-y divide-border">
            {drafts.map((draft, index) => (
              <div
                ...
                className="px-6 py-4 hover:bg-muted/50 transition-all duration-200 group border-l-4 border-l-transparent hover:border-l-accent animate-fade-in-up"
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  value={newDraft.to}
                  onChange={(e) => setNewDraft({ ...newDraft, to: e.target.value })}
